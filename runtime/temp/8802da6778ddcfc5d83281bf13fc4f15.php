<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/www/wwwroot/ql.bjoyhg.com/public/../application/login/view/index/adminlogin.html";i:1561474068;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
	<meta charset="UTF-8" />
	...
	<div class="wechat__panel clearfix">
		<div class="wc__home-wrapper flexbox flex__direction-column">
			...
			<div class="wc__lgregPanel flex1">
				<h2 class="hdtips">管理员账号登录</h2>
				<div class="forms">
					<form action="login.html" method="post" id="loginForm" autocomplete="on">
						<ul class="clearfix">
							<li><label class="lbl flexbox"><em>账号</em><input class="iptxt flex1" type="text" name="account" placeholder="请填写管理员账号" /></label></li>
