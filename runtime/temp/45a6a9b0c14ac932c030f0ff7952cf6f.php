<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/www/wwwroot/ql.bjoyhg.com/public/../application/login/view/index/reg.html";i:1561474068;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
	<meta charset="UTF-8" />
	...
	<div class="wechat__panel clearfix">
		<div class="wc__home-wrapper flexbox flex__direction-column">
			...
			<div class="wc__lgregPanel flex1">
				...
				<div class="forms">
					<form action="reg.html" method="post" id="loginForm" autocomplete="on">
						<ul class="clearfix">
							<li><label class="lbl flexbox"><em>账号</em><input class="iptxt flex1" type="text" name="account" placeholder="请填写登陆账号" /></label></li>
							<li><label class="lbl flexbox"><em>昵称</em><input class="iptxt flex1" type="text" name="nickname" placeholder="请填写昵称" /></label></li>
							<li><label class="lbl flexbox"><em>密码</em><input class="iptxt flex1" type="password" name="password" placeholder="请填写密码" /></label></li>
							<li><label class="lbl flexbox"><em>重复密码</em><input class="iptxt flex1" type="password" name="password2" placeholder="再次输入密码" /></label></li>
							<input type="hidden" name="tj" value ='1'/>
						</ul>
						<div class="lgway"><a href="javascript:;" class="J__swtLgWay">切换登录方式</a></div>
						<div class="btns"><a class="wc__btn-primary btn__login" id="J__btnreg" onclick="document:loginForm.submit()" href="javascript:;">注册</a>
						<br>
						<a class="wc__btn-primary btn__login" id="J__btnLogin" href="javascript:;">登录</a></div>
					</form>
				</div>
			</div>
			<!-- //底部 -->
